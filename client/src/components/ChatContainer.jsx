...
const ChatContainer = () => {
  ...
  return selectedUser?(
    ...
    <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
      <input onChange={(e)=>setInput(e.target.value)} type='text' placeholder='Type a message...' className='flex-1 text-sm p-3 border-none rounded-lg outline-none' value={input} onKeyDown={(e)=>e.key==="Enter"? handleSendMessage(e):null}/>
